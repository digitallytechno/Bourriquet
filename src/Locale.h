...
struct fcstr
	{
  		const char * const defmsg; // la chaîne du catalogue par défaut
  		const char * msg;          // la chaîne traduite/convertie du catalogue
  		const long id;             // identifiant chaîne du catalogue
	};
