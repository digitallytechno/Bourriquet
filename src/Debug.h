...
#define DBF_CLASSES   (1<<2)	// pour la sortie de la gestion des classes (Classes.c)
...
#define DBF_SERVER (1<<5)	// pour la sortie de la gestion des serveurs (ServerMet.c)
#define DBF_SHARE     (1<<6)     // pour la sortie de la gestion des fichiers à partager (Share.c)
#define DBF_CONFIG (1<<7)	// pour la gestion de la configuration (Config.c)
#define DBF_NET      (1<<8)    // pour la sortie de gestion réseau (tcp/ ...)
#define DBF_UTIL     (1<<9)    // pour la sortie de gestion des utilitaires (Utilities.c)
#define DBF_IMAGE    (1<<10)    // pour le chargement/la maintenance des fichiers images et du cache (ImageCache.c)
